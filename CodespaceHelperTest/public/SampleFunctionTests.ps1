...
function CodespaceHelperTest_GetPublicString{ 
...
function CodespaceHelperTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "CodespaceHelper.psd1"
...
Export-ModuleMember -Function CodespaceHelperTest_*
